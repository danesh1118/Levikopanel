...
<!-- LANG:FA -->
تمام تغییرات و بروزرسانی‌های پروژه LEVIKO (Project LEVIKO) در این فایل مستند خواهند شد.
<!-- LANG:FA -->
<!-- LANG:EN -->
All notable changes to Project LEVIKO will be documented in this file.
<!-- LANG:EN -->
...
- **اتصال ربات تلگرام از داشبورد**: مدیریت کامل پنل از طریق دکمه‌های تلگرام.
...
- **Telegram Bot from Dashboard**: Full panel management via inline Telegram buttons.
...
### بهبود یافته (Improved)
- **پایداری فرم‌‌ها و اشتراک**: افزایش پایداری و اصلاح کنترل اعتبارهای سمت سرور و فرانت‌اند برای ارتقای امنیت و سرعت پنل LEVIKO.
<!-- LANG:FA -->
